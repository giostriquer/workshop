...
REVIEW CLOSURE (per discipline): <code | tests> · <reviewed revision> · <reviewer-confirmed finding IDs/dispositions + evidence> · follow-up passes: <n> · hold: <none, or the convergence condition that stopped this review>
