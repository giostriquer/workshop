---
name: route-work
description: Reference table for the model fleet — cost / intelligence / taste / code / speed per model, plus the hard routing invariants. Use when a model choice needs grounding and isn't already settled. A lookup, not a process — not a step before every dispatch, and it never dispatches anything.
---
