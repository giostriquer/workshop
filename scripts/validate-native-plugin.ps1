...
function Assert-ToolkitPlugin {
    ...
    $expectedSkills = @("arch-map", "claim-check", "code-quality-review", "doc-to-html", "empirical-proof", "get-pr-comments", "handoff-goal", "handoff-pr", "handoff-review", "qa-sweep", "route-work", "ui-demo-video")
