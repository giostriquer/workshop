...
function Assert-ToolkitPlugin {
    ...
    $expectedSkills = @("arch-map", "claim-check", "code-quality-review", "doc-to-html", "empirical-proof", "file-pr", "fix-ci", "get-pr-comments", "handoff-goal", "qa-sweep", "route-work", "ui-demo-video")
